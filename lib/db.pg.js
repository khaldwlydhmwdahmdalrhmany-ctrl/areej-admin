...
export async function updateProduct(id, data) {
  ...
  await getPool().query(
    `UPDATE products SET name=$1, description=$2, "fullDescription"=$3, price=$4, "oldPrice"=$5, badge=$6, "imageUrl"=$7, "freeShipping"=$8, "freeInstall"=$9, "categoryId"=$10, published=$11, "updatedAt"=now()
     WHERE id=$12`,
    [
      ...
      merged.categoryId, !!merged.published, id,
    ]
  );
  return await getProductById(id);
}
